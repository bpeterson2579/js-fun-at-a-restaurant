...
var vegetables = ['tomatoe', 'zucchini', 'peas', 'carrot', 'broccoli'];
...
// different fruits.
var fruits = ['apple', 'banana', 'orange', 'grapefruit', 'strawberry', 'lemon', 'lime']
...
// It would make sense to have location: 'Denver', hasButcher: true, and/or phoneNumber: 303-whatever.
var groceryStore = {
  name: 'King Soopers',
  isOpen: true
}
